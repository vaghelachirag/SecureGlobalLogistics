package com.app.secureglobal.model.pendingRequest
...
class GetPendingRequestResponse {
    ...
    @SerializedName("data")
    @Expose
    private var data: ArrayList<GetPendingRequestData>? = null
    ...
    fun getData(): ArrayList<GetPendingRequestData>? {
        return data!!
    }

    fun setData(data: ArrayList<GetPendingRequestData>?) {
        this.data = data
    }
