package com.app.secureglobal.model.getDocketforPickupResponse
...
class GetDocketForPickupData {
    ...
    @Expose
    private var destinationBranchId: Any? = null
    ...
    @Expose
    private var branchList: Any? = null
    ...
    fun getDestinationBranchId(): Any? {
        return destinationBranchId
    }

    fun setDestinationBranchId(destinationBranchId: Any?) {
    ...
    fun getBranchList(): Any? {
        return branchList
    }

    fun setBranchList(branchList: Any?) {
