package com.app.secureglobal.model.registerDevice
...
class GetDeviceRegistrationResponse {
    ...
    @SerializedName("data")
    @Expose
    private var data: GetDeviceRegistrationData? = null
    ...
    fun getData(): GetDeviceRegistrationData? {
        return data
    }

    fun setData(data: GetDeviceRegistrationData?) {
        this.data = data
    }
