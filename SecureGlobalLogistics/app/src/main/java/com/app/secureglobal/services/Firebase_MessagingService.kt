package com.app.secureglobal.services
...
import com.app.secureglobal.uttils.Session.Companion.KEY_USER_TOKEN
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder = Notification.Builder(this)
                ...
                .setContentText(remoteMessage.notification!!.body)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setLargeIcon(BitmapFactory.decodeResource(this.resources, com.app.secureglobal.R.drawable.ic_launcher_background))
                .setContentIntent(pendingIntent)
        }
